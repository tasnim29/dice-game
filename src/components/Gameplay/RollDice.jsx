...
const RollDice = ({ handleDice, dice, resetScore }) => {
  ...
  return (
    <div className="text-center">
      ...
      <div>
        <button className="bg-black text-white font-medium px-10 py-3 mt-6 border border-gray-300 shadow hover:shadow-lg hover:-translate-y-1 hover:bg-white hover:text-black transition-all duration-300 ease-in-out cursor-pointer">
          Show Rules
        </button>
      </div>
    </div>
